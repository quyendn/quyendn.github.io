    ...
    $('#frmRegDownload').bootstrapValidator({
        ...
        onSuccess: function(e) {
            ...
            if (isEmpty(source))
                ...
                url_source = source;
            var dataJSON = { "name": name, "phone": phone, "email": email,"nganhhoc":nganhhoc,"loaihinh":loaihinh,"source": url_source, "emailto": emailto,"typeId" :1 }
            ...
            $.ajax({
                ...
                complete: function(jqXHR, textStatus) {
                    ...
                    location.href = "http://ts2020.phenikaa-uni.edu.vn/kinhte-ngoaingu/dang-ky-thanh-cong.html";
                }
            });
        }
