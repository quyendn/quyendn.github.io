    ...
    $.fn.dateTimePicker = function (options) {
        ...
        return this.each(function () {
            ...
            function updateMainElemGlobal() {
                ...
                elem.append($s);
                $s = $('<i>');
                $s.addClass('fal fa-calendar-check');
                elem.append($s);
            ...
            elem.on('click', function () {
                ...
                function createMonthPanel(selectMonth) {
                    ...
                    var $s = $('<i></i>');
                    $s.addClass('fal fa-angle-left cursorily ico-size-month hov');
                    ...
                    $d.append($s);
                    $s = $('<i></i>');
                    $s.addClass('fal fa-angle-right cursorily ico-size-month hov');
                ...
                function createTimer() {
                    ...
                    $i.addClass('fal fa-angle-up ico-size-large cursorily hov');
                    $panel.append($i);
                    var $m = $('<span>');
                    ...
                    $i.addClass('fal fa-angle-down ico-size-large cursorily hov');
                    $panel.append($i);
                    $m = $('<span>');
                    $m.addClass('dtp_modal-midle');
                    $panel.append($m);
                ...
                function updateMainElem() {
                    ...
                    elem.append($s);
                    $s = $('<i>');
                    $s.addClass('fal fa-calendar-check ico-size');
                    elem.append($s);
                    if (settings.showTime) {
                        $s = $('<span>');
                        $s.text(lastSelected.format(arrF[1]));
                        elem.append($s);
                        $s = $('<i>');
                        $s.addClass('fal fa-clock ico-size');
                        elem.append($s);
                    }
                }
